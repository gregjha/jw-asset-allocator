...
- Users can also manually refresh the conversion rates on demand if they want a quicker update. A throttle is added for the manual refresh to prevent users from calling the API too frequently. This was not completely necessary, but wanted to add multiple options for the project.
