...
export const useCryptoSplitStore = defineStore('cryptoSplit', () => {
  const { rates, isFetching, isRefreshThrottled, error, lastUpdated, refresh } = useCryptoRates(30000)
  ...
  return { rates, isFetching, isRefreshThrottled, error, lastUpdated, symbols, splitFor, refresh }
})
